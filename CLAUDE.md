...
- `codebase-hotspotsv2` uses a two-tier detection architecture:
  ...
  - The shared contract (foundational definitions, Confidence, Severity, finding format) lives in `.claude/skills/codebase-hotspotsv2/shared-rules.md` and is referenced by all agents and the orchestrator.
